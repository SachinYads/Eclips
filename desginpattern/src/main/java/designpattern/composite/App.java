...
public class App {
	 ...
	 * Implementing this pattern lets clients treat individual objects and compositions uniformly.
	 * 
	 * 
	...
	public static void main(String[] args) {
		...
		LetterComposite elvesMessage= new Messanger().messageFromElves();
		elvesMessage.print();
		
		System.out.println("\nMessage from the orcs: ");
		LetterComposite orcsMessage= new Messanger().messageFromOrcs();
		orcsMessage.print();
		}
