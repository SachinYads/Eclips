...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "com.todo";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/NoteTaker-model"),
        mapper("/NoteTaker-dao"),
        mapperxml("/NoteTaker-web"),
        service("/NoteTaker-service"),
        web("/NoteTaker-web"),
        ;
